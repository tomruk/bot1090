...
* Telegram bot for receiving the captured data
* Telegram bot that has notifier feature that informs you when a specific plane is seen by bot1090
...
* TCP server streaming and receiving raw data to/from connected clients
  (using --net and --maps-api-key).

This is the fork of the dump1090 which is originally developed by [antirez](https://github.com/antirez). However there is a
[much more feature complete fork](https://github.com/MalcolmRobb/dump1090)
available, developed by MalcolmRobb. (Doesn't include a Telegram bot)

Installation
---

Install the [tgbot-cpp](https://github.com/reo7sp/tgbot-cpp)
Type "make".
...
on standard output, just run the program without options at all (doesn't run the Telegram bot):

    ./bot1090
    
To run with a Telegram bot:

    ./bot1090 --bot-token YOUR-TOKEN-HERE
...
with your browser to http://localhost:8080 to see live traffic (A Google Maps api key is required!):

    ./bot1090 --interactive --net --maps-api-key YOUR-API-KEY-HERE
...
like this:
    ...
    nc remote-bot1090.example.net 30002 | nc localhost 30001
...
Just run it like this:
    ...
    ./bot1090 --ifile testfiles/modes1.bin
...
Use it like this:
    ...
    cat big.bin | ./bot1090 --snip 25 > small.bin
...
I am a high school student who is busy with a goddamn education system, so this project is a hobby for me.
Just send a pull request if you want to contribute.